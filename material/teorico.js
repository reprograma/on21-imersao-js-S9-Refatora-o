...
1- Por que não refatoramos códigos incorretos? Com por exemplo Abusos de OO? 
  Acredito que se for refatorar um código incorreto, não seria apenas um processo de refatorar e sim de criação, pois teríamos que corrigir e criar novas funcionalidades, já que está incorreto
2- Se um código se demonstra incompleto, por mais que funcione grande parte, o que devemos fazer?
  Perguntar a pessoa que pediu para refatorar se quer que refatore a parte que funcione ou fazer a correção da parte que está incompleta, que já não seria refatoração
3- Ao decorrer da refatoração você se depara com um processo muito complexo que não poderia otimizar, qual a melhor maneira de prosseguir?
  Pedir ajudar
